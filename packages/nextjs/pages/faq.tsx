  ...
  return (
    <div className="max-w-3xl px-4 py-8">
      ...
      <div className="space-y-10">
        <div>
          <h2 className="font-bold text-secondary">What is the BG Ship Yard?</h2>
          <p>
            The BG Ship Yard is an initiative by BuidlGuidl aimed at funding focused, high-leverage open-source
        ...
        <div>
          ...
          <p>
            The BG Ship Yard is just a working group inside the BuidlGuidl community. Maintaining the spirit of the
            BuidlGuidl – learning and experimentation – the BG Ship Yard adds intentionality, a focus on quality, and
            commits to delivering complete projects.
          </p>
        </div>

        <div>
          <h2 className="font-bold text-secondary">What are the core values of the BG Ship Yard?</h2>
        ...
        <div>
          <h2 className="font-bold text-secondary">How can I join the BG Ship Yard?</h2>
          <p>There is no single path or application process to join the BG Ship Yard.</p>
          <p>
        ...
        <div>
          ...
          <p>Developers can withdraw from their stream when working on any of the BG Ship Yard's projects.</p>
        </div>
        <div>
          <h2 className="font-bold text-secondary">Who is funding this initiative?</h2>
          <p>The BG Ship Yard is funded by the BuidlGuidl.</p>
        </div>
      </div>
    </div>
  );
